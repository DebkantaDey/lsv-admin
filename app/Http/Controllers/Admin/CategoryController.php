        ...
        try {
            ...
            if ($request->ajax()) {
                ...
                if ($input_search != null && isset($input_search)) {
                    if ($input_type != 0) {
                        $data = Category::where('name', 'LIKE', "%{$input_search}%")->where('type', $input_type)->latest()->get();
                    } else {
                        $data = Category::where('name', 'LIKE', "%{$input_search}%")->latest()->get();
                    }
                } else {
                    if ($input_type != 0) {
                        $data = Category::where('type', $input_type)->latest()->get();
                    } else {
    ...
    public function destroy($id)
    {
        try {
            ...
            if (isset($data)) {
                ...
                Interests_Category::where('category_id', $id)->delete();
                Rent_Section::where('category_id', $id)->delete();
            }
