    ...
    public function store(Request $request)
    {
        try {
            $validator = Validator::make($request->all(), [
                ...
                'ads_free' => 'required',
                'download' => 'required',
                'verifly_artist' => 'required',
                'verifly_account' => 'required',
            ]);
            if ($validator->fails()) {
            ...
            $requestData['no_of_device'] = 0;
            $requestData['size_of_data_upload'] = "";
            $requestData['background_play'] = 0;
            ...
            if (isset($package_data->id)) {
                ...
                // Package Details
                Package_Detail::where('package_id', $package_data->id)->delete();
                Package_Detail::insert([
                    ['package_id' => $package_data->id, 'package_key' => "Ad-free content", 'package_value' => $package_data->ads_free],
                    ['package_id' => $package_data->id, 'package_key' => "Download content (offline view)", 'package_value' => $package_data->download],
                    ['package_id' => $package_data->id, 'package_key' => "Verifly Your account", 'package_value' => $package_data->verifly_account],
                    ['package_id' => $package_data->id, 'package_key' => "Verifly Your artist account", 'package_value' => $package_data->verifly_artist],
                ]);
