            ...
            <div class="border-bottom row mb-3">
                <div class="col-sm-10">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('video.index') }}">{{__('Label.Videos')}}</a>
                        </li>
                            ...
                            <div class="form-row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class="form-control" rows="6" placeholder="Describe Here,">@if($data){{$data->description}}@endif</textarea>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
