...
@section('content')
    ...
    <div class="right-content">
        ...
        <div class="body-content">
            <!-- mobile title -->
            <h1 class="page-title-sm">Edit Reels</h1>
            ...
            <div class="border-bottom row mb-3">
                ...
                <div class="col-sm-2 d-flex align-items-center justify-content-end">
                    <a href="{{ route('reels.index') }}" class="btn btn-default mw-120" style="margin-top:-14px">Reels List</a>
                </div>
            </div>
            ...
            <div class="card custom-border-card mt-3">
                <form id="reels" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="title" class="form-control" rows="1" placeholder="Captions Here," autofocus>@if($data){{$data->title}}@endif</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div style="display: block;">
                                            ...
                                            <label class="mt-3 text-gray">@if($data){{$data->content}}@endif</label>
                                        </div>
                    ...
                    <div class="border-top pt-3 text-right">
                        ...
                        <a href="{{route('reels.index')}}" class="btn btn-cancel mw-120 ml-2">{{__('Label.CANCEL')}}</a>
		...
		function save_reels(){
            ...
            if(Check_Admin == 1){
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    url: '{{route("reels.update", [$data->id])}}',
                    data: formData,
                    cache:false,
                    contentType: false,
                    processData: false,
                    success:function(resp){
                        $("#dvloader").hide();
                        get_responce_message(resp, 'reels', '{{ route("reels.index") }}');
                    },
