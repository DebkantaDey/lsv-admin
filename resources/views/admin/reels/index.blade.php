...
@section('content')
    ...
    <div class="right-content">
        ...
        <div class="body-content">
            ...
            <!-- Search -->
            <form action="{{ route('reels.index')}}" method="GET">
            ...
            <div class="row">
                <div class="col-12 col-sm-6 col-md-4 col-xl-3">
                    <a href="{{ route('reels.create') }}" class="add-video-btn">
                        ...
                        <div class="position-relative">
                            ...
                            <ul class="list-inline overlap-control" aria-labelledby="dropdownMenuLink">
                                <li class="list-inline-item">
                                    <a class="btn" href="{{route('reels.edit', [$value->id])}}" title="Edit">
                                        <i class="fa-solid fa-pen-to-square fa-xl" class="dot-icon" style="color: #4e45b8;"></i>
                                    </a>
                                </li>
                                <li class="list-inline-item">
                                    <a class="btn" href="{{route('reels.show', [$value->id])}}" title="Delete" onclick="return confirm('Are you sure !!! You want to Delete this Reels ?')">
