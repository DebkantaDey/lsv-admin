    ...
    <div class="right-content">
        ...
        <div class="body-content">
            ...
            <div class="card custom-border-card mt-3">
                <h5 class="card-header">Add Gift</h5>
                <div class="card-body">
                    <form id="gift" enctype="multipart/form-data">
            ...
            <div class="card custom-border-card mt-3">
                <div class="page-search mb-3">
                    <div class="input-group" title="Search">
                        ...
                        <input type="text" id="input_search" class="form-control" placeholder="Search Gift" aria-label="Search" aria-describedby="basic-addon1">
                    </div>  
                </div>
            ...
            <div class="modal fade" id="EditModel" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <form id="edit_gift" autocomplete="off">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default mw-120" onclick="update_gift()">Update</button>
