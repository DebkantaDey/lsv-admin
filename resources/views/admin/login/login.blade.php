                ...
                <div class="mx-auto col-sm-12 col-md-10 col-xl-8">
                    <div class="py-5">
                            ...
                            <div class="form-row mt-4">
                                <div class="col-md-6">
                                    <div class="position-relative form-group">
                                        <label>Email</label>
                                        <input name="email" type="email" value="{{ $emailValue }}" class="form-control" placeholder="Email here..." autofocus>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="position-relative form-group">
                                        <label>Password</label>
                                        <input name="password" type="password" value="{{ $passwordValue }}" placeholder="Password here..." class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                        ...
                        @if( env('DEMO_MODE') == 'ON') 
                            <hr>
                            <h6>
                                If you cannot login, then <a href="{{ env('APP_URL'). '/public/admin/login' }}" target="_blank" class="btn-link">Click Here</a>
                            </h6>
                        @endif
                    </div>
                </div>
