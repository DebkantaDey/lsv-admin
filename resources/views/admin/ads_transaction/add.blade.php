...
@section('page_title','Add Coin Transaction')
            ...
            <div class="border-bottom row mb-3">
                <div class="col-sm-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('adtransaction.index') }}">Coin Transaction</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Add Coin Transaction</li>
                    </ol>
                </div>
            </div>
                ...
                <form enctype="multipart/form-data" id="search_user">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-4">
                            ...
                            <a href="{{route('adtransaction.create')}}" class="btn btn-cancel mw-120">Clear</a>
                        </div>
                    </div>
                </form>
            </div>
            ...
            if(Check_Admin == 1){
                ...
                $.ajax({
                    ...
                    success: function(resp) {
                        $("#dvloader").hide();
                        get_responce_message(resp, 'add_transaction', '{{ route("adtransaction.index") }}');
                    },
