    ...
    <script>
            ...
            if(Check_Admin == 1){
                ...
                $.ajax({
                    ...
                    success:function(resp){
                        $("#dvloader").hide();
                        get_responce_message(resp, 'podcasts', '{{ route("podcasts.index") }}');
                    },
        ...
        function update_podcasts() {
            ...
            if(Check_Admin == 1){
                ...
                var url = '{{ route("podcasts.update", ":id") }}';
                ...
                $.ajax({
                    ...
                    success: function(resp) {
                        ...
                        get_responce_message(resp, 'edit_podcasts', '{{ route("podcasts.index") }}');
                    },
                    error: function(XMLHttpRequest, textStatus, errorThrown) {
                        $("#dvloader").hide();
                        toastr.error(errorThrown.msg, 'failed');
        ...
        function change_status(id, status) {
            ...
            if(Check_Admin == 1){
                ...
                $("#dvloader").show();
                var url = "{{route('podcasts.show', '')}}" + "/" + id;
                $.ajax({
                    type: "GET",
                    url: url,
                    headers: {
