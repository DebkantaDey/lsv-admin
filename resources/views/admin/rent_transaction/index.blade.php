...
@section('page_title', 'Rent Transaction')
        ...
        <div class="body-content">
            ...
            <div class="border-bottom row mb-3">
                ...
                <div class="col-sm-2 d-flex align-items-center justify-content-end">
                    <a href="{{ route('renttransaction.create') }}" class="btn btn-default mw-120" style="margin-top:-14px">Add Transaction</a>
                </div>
            </div>
...
@section('pagescript')
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#input_type, #input_user').change(function() {
                table.draw();
            });
