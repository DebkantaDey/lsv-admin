                                ...
                                <div class="form-row">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="country_code" value="@if($data){{$data->country_code}}@endif" class="form-control" placeholder="+91">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                ...
                                <div class="form-row">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="country_name" value="@if($data){{$data->country_name}}@endif" class="form-control" placeholder="IN">
                                        </div>
                                    </div>
                                </div>
                            </div>
