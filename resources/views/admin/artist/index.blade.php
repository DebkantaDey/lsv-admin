...
@section('page_title', __('Label.Artist'))
...
@section('content')
    ...
    <div class="right-content">
        ...
        <div class="body-content">
            <!-- mobile title -->
            <h1 class="page-title-sm"> {{__('Label.Artist')}} </h1>

            <div class="border-bottom row mb-3">
                <div class="col-sm-12">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">{{__('Label.Dashboard')}}</a></li>
                        <li class="breadcrumb-item active" aria-current="page">{{__('Label.Artist')}}</li>
                    </ol>
                </div>
            </div>
                                ...
                                <div class="form-row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="bio" rows="2" class="form-control" placeholder="Describe Your Self..."></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>{{__('Label.Bio')}}</label>
                                                    <textarea name="bio" rows="2" id="edit_bio" class="form-control" placeholder="Describe Your Self..."></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
