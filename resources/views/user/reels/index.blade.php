...
@section('content')
    ...
    <div class="right-content">
        ...
        <div class="body-content">
            <!-- mobile title -->
            <h1 class="page-title-sm">Reels</h1>

            <div class="border-bottom row mb-3">
                <div class="col-sm-12">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('user.dashboard') }}">{{__('Label.Dashboard')}}</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Reels</li>
                    </ol>
                </div>
            </div>

            <!-- Search -->
            <form action="{{ route('ureels.index')}}" method="GET">
                <div class="page-search mb-3">
                    <div class="input-group">
                        ...
                        <input type="text" name="input_search" value="@if(isset($_GET['input_search'])){{$_GET['input_search']}}@endif" class="form-control" placeholder="Search Reels" aria-label="Search" aria-describedby="basic-addon1">
                    </div>
            ...
            <div class="row">
                <div class="col-12 col-sm-6 col-md-4 col-xl-3">
                    <a href="{{ route('ureels.create') }}" class="add-video-btn">
                ...
                <div class="col-12 col-sm-6 col-md-4 col-xl-3">
                    <div class="card video-card">
                        <div class="position-relative">
                            ...
                            <button class="btn play-btn-top video" data-toggle="modal" data-target="#videoModal" data-video="{{$value->content}}" data-image="{{$value->portrait_img}}">
                            ...
                            <ul class="list-inline overlap-control" aria-labelledby="dropdownMenuLink">
                                <li class="list-inline-item">
                                    <a class="btn" href="{{route('ureels.edit', [$value->id])}}" title="Edit">
                                        <i class="fa-solid fa-pen-to-square fa-xl" class="dot-icon" style="color: #4e45b8;"></i>
                                    </a>
                                </li>
                                <li class="list-inline-item">
                                    <a class="btn" href="{{route('ureels.show', [$value->id])}}" title="Delete" onclick="return confirm('Are you sure !!! You want to Delete this Reels ?')">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between">
                                @if($value->status == 1)
                                <button class="btn btn-sm" style="background:#058f00; color:#fff; font-weight:bold; border:none">Show</button>
                                @elseif($value->status == 0)
                                <button class="btn btn-sm" style="background:#e3000b; color:#fff; font-weight:bold; border:none">Hide</button>
                                @endif
