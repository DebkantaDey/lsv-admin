...
@section('content')
    ...
    <div class="right-content">
        ...
        <div class="body-content">
            <!-- mobile title -->
            <h1 class="page-title-sm">Add Ads</h1>
            ...
            <div class="border-bottom row mb-3">
                ...
                <div class="col-sm-2 d-flex align-items-center justify-content-end">
                    <a href="{{ route('uads.index') }}" class="btn btn-default mw-120" style="margin-top:-14px">Ads List</a>
                </div>
            </div>
            ...
            <div class="card custom-border-card mt-3">
                <form id="ads" enctype="multipart/form-data">
                    ...
                    <div class="border-top pt-3 text-right">
                        ...
                        <a href="{{route('uads.index')}}" class="btn btn-cancel mw-120 ml-2">{{__('Label.CANCEL')}}</a>
		...
		function save_ads(){
            ...
            $.ajax({
                ...
                success:function(resp){
                    $("#dvloader").hide();
                    get_responce_message(resp, 'ads', '{{ route("uads.index") }}');
                },
