...
@section('content')
    ...
    <div class="right-content">
        ...
        <div class="body-content">
            <!-- mobile title -->
            <h1 class="page-title-sm">Podcasts</h1>
            ...
            <div class="card custom-border-card mt-3">
                <h5 class="card-header">Add Podcasts</h5>
                <div class="card-body">
                    ...
                    <div class="modal-content">
                        ...
                        <form id="edit_podcasts" autocomplete="off">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default mw-120" onclick="update_podcasts()">Update</button>
...
@section('pagescript')
    <script>
        ...
        function save_podcasts(){
            ...
            $.ajax({
                ...
                success:function(resp){
                    $("#dvloader").hide();
                    get_responce_message(resp, 'podcasts', '{{ route("upodcasts.index") }}');
                },
        ...
        function update_podcasts() {
            ...
            var url = '{{ route("upodcasts.update", ":id") }}';
            ...
            $.ajax({
                ...
                success: function(resp) {
                    ...
                    get_responce_message(resp, 'edit_podcasts', '{{ route("upodcasts.index") }}');
                },
                error: function(XMLHttpRequest, textStatus, errorThrown) {
                    $("#dvloader").hide();
                    toastr.error(errorThrown.msg, 'failed');
