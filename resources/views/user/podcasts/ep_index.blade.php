        ...
        <div class="body-content">
            ...
            <div class="border-bottom row mb-3">
                <div class="col-sm-12">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('upodcasts.index') }}">Podcasts</a></li>
            ...
            <!-- Search -->
            <form action="{{ route('upodcast.episode.index', $podcasts_id)}}" method="GET">
            ...
            <div class="row">
                <div class="col-12 col-sm-6 col-md-4 col-xl-3">
                    <a href="{{ route('upodcast.episode.add', $podcasts_id) }}" class="add-video-btn">
                        ...
                        <div class="position-relative">
                            ...
                            <ul class="list-inline overlap-control" aria-labelledby="dropdownMenuLink">
                                <li class="list-inline-item">
                                    <a class="btn" href="{{route('upodcast.episode.edit', [$podcasts_id, $value->id])}}" title="Edit">
                                        <i class="fa-solid fa-pen-to-square fa-xl" class="dot-icon" style="color: #4e45b8;"></i>
                                    </a>
                                </li>
                                <li class="list-inline-item">
                                    <a class="btn" href="{{route('upodcast.episode.delete', [$podcasts_id, $value->id])}}" title="Delete" onclick="return confirm('Are you sure !!! You want to Delete this Episode ?')">
...
@section('pagescript')
    <script>
        ...
        function save_episode_sortable() {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route("upodcast.episode.sortable") }}',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
                success: function(resp) {
                    $("#dvloader").hide();
                    get_responce_message(resp, 'save_episode_sortable', '{{ route("upodcast.episode.index", $podcasts_id)}}');
                },
